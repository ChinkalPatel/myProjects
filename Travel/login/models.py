...
class HotelUserData(models.Model):
    ...
    hotel_ticket_name=models.CharField(max_length=100,blank = True)
    hotel_ticket_room_type=models.CharField(max_length=100,blank = True)
    hotel_checkin=models.DateTimeField(blank = True)
    hotel_no_of_day=models.IntegerField(blank = True)
    hotel_no_of_ticket=models.IntegerField(blank = True)
    hotel_ticket_price=models.IntegerField(blank = True)
    hotel_ticket_payment=models.CharField(max_length=10,blank = True)
