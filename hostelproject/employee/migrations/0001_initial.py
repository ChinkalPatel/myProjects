# Generated by Django 2.1.7 on 2019-02-24 16:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_no', models.DecimalField(blank=True, db_column='contact_NO', decimal_places=0, max_digits=10, null=True)),
                ('aadhar_no', models.DecimalField(blank=True, db_column='aadhar_No', decimal_places=0, max_digits=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_status', models.CharField(blank=True, db_column='payment_Status', max_length=3, null=True)),
                ('ingredients_details_ingredient', models.ForeignKey(db_column='Ingredients_details_ingredient_Id', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='employee.IngredientsDetails')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_employeeid', models.OneToOneField(db_column='employee_employeeId', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='employee.Employee')),
            ],
            options={
                'db_table': 'salary',
                'managed': False,
