# Generated by Django 2.0.2 on 2019-01-23 17:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_status', models.CharField(blank=True, db_column='payment_Status', max_length=3, null=True)),
                ('ingredients_details_ingredient', models.ForeignKey(db_column='Ingredients_details_ingredient_Id', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='admission.IngredientsDetails')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_employeeid', models.ForeignKey(db_column='employee_employeeId', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='admission.Employee')),
            ],
            options={
                'db_table': 'salary',
                'managed': False,
