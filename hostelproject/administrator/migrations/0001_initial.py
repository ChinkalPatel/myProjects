# Generated by Django 2.1.7 on 2019-03-04 02:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Gatepass',
            fields=[
                ('gatepassid', models.AutoField(db_column='gatepassId', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_status', models.CharField(blank=True, db_column='payment_Status', max_length=3, null=True)),
                ('ingredients_details_ingredient', models.ForeignKey(db_column='Ingredients_details_ingredient_Id', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='administrator.IngredientsDetails')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_employeeid', models.OneToOneField(db_column='employee_employeeId', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='administrator.Employee')),
            ],
            options={
                'db_table': 'salary',
                'managed': False,
